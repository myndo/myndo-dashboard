window.MYNDO_DASHBOARD = {
    ...
    changeChartColor : function(color, select_graph, chart, chartA) {
    ...
    updateGraphColor : function(select_graph, chart, chartA, currentHue, currentSaturation, currentLightness) {
        let color = this.hslToHex(currentHue, currentSaturation, currentLightness);
        if (select_graph.value == "graph-2") {
            chart.options.title.fontColor = color;
            chart.render();
        } else {
    ...
    updateColorDisplay : function(colorArea, currentHue, currentSaturation, currentLightness, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA) {
        ...
        let color = `hsl(${currentHue}, ${currentSaturation}%, ${currentLightness}%)`;
        
        opacitySlider.style.backgroundColor = color;
        
        let hexColor = this.hslToHex(currentHue, currentSaturation, currentLightness);
        hexInput.value = hexColor;
        
        document.querySelector('.opacity-value').textContent = `${currentOpacity}%`;
        this.updateGraphColor(select_graph, chart, chartA, currentHue, currentSaturation, currentLightness)
    },

    updateColorFromPosition : function(e, colorArea, colorSelector, currentSaturation, currentLightness, currentHue, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA) {
        e.preventDefault();
        ...
        this.updateColorDisplay(colorArea, currentHue, currentSaturation, currentLightness, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA);
    },

    startColorSelection : function(e, isDragging, colorArea, colorSelector, currentSaturation, currentLightness, currentHue, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA) {
        isDragging = true;
        this.updateColorFromPosition(e, colorArea, colorSelector, currentSaturation, currentLightness, currentHue, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA);
    },

    moveColorSelector : function(e, isDragging, colorArea, colorSelector, currentSaturation, currentLightness, currentHue, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA) {
    ...
    init : function() {
        ...
        chart.render();
            ...
            chartA = new CanvasJS.Chart("chartContainerCircle", {
                animationEnabled: true,
                title: {
                    text: "Channel Mix",
                    fontSize: 18,
            ...
            window.addEventListener('click', function(e) {
                if (screen_options_design.style.marginRight !== 0 + "px" && !button_options_design.contains(e.target) && !screen_options_design.contains(e.target) && !dog_graph.contains(e.target) && !lin_graph.contains(e.target)) {
                    ...
                    this.MYNDO_DASHBOARD.reset_button_color(button_options_design);
                    dog.style.border = "none";
                    lin.style.border = "none";
                }
            })
            ...
            colorSamples.forEach(function(sample) {
                sample.addEventListener('click', function() {
                    ...
                    window.MYNDO_DASHBOARD.changeChartColor(color, select_graph, chart, chartA);
                });
            });
            ...
            hueSlider.addEventListener('input', function () {
                ...
                window.MYNDO_DASHBOARD.updateColorDisplay(colorArea, currentHue, currentSaturation, currentLightness, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA);
            });
        ...
        window.addEventListener('click', function(e) {
            ...
            if (sidebar_save_report.style.marginRight !== 0 + "px" && !save_report_button.contains(e.target) && !sidebar_save_report.contains(e.target)) {
                ...
                this.MYNDO_DASHBOARD.reset_button_color(save_report_button);
            }
        ...
        colorArea.addEventListener('mousedown', function(e) {
            window.MYNDO_DASHBOARD.startColorSelection(e, isDragging, colorArea, colorSelector, currentSaturation, currentLightness, currentHue, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA);
        });
        document.addEventListener('mousemove', function(e) {
            window.MYNDO_DASHBOARD.moveColorSelector(e, isDragging, colorArea, colorSelector, currentSaturation, currentLightness, currentHue, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA);
        });
        document.addEventListener('mouseup', () => { isDragging = false; });
        
        colorArea.addEventListener('touchstart', function(e) {
            window.MYNDO_DASHBOARD.startColorSelection(e, isDragging, colorArea, colorSelector, currentSaturation, currentLightness, currentHue, opacitySlider, hexInput, currentOpacity, select_graph, chart, chartA);
        });
